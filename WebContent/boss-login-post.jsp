...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    ...
    <a href="#" class="w3-bar-item w3-button w3-hide-small w3-hover-white">系統管理</a>
    ...
    <a href="#" class="w3-bar-item w3-button w3-hide-small w3-hover-white">本學期住宿名單</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row">
    <div class="post" align="center">
      ...
      <a href="#" class="w3-hover-red">新增公告</a>
    </div>
    <hr>
