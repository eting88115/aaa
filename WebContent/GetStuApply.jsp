...
<%
 ...
 String department = request.getParameter("department");out.println(department);
 String classroom = request.getParameter("classroom");out.println(classroom);
 String sex=request.getParameter("sex");out.println(sex);
%>

         <table>
              <tr><td><label for="name">姓名:</label><%=name %></td>
                   <td><label for="department">科系:</label><%=department%></td></tr><tr><td></td><td></td></tr>
              <tr><td><label for="account">學號:</label><%=account %></td>
                  <td><label for="phone">電話:</label><%=phone %></td></tr><tr><td></td><td></td></tr>
              <tr><td><label for="sex">性別:</label><%=sex %></td>
                  <td><label for="photo">戶籍資料圖片檔:</label><%=photo %></td></tr><tr><td></td><td></td></tr>
              <tr><td><label for="classroom">班級:</label><%=classroom %></td>
                  <td><label for="email">信箱:</label><%=email %></td></tr><tr><td></td><td></td></tr>
              <tr><td><label for="address">住址:</label><%=address %></td><td></td></tr><tr><td></td><td></td></tr>
