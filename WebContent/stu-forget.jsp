...
<!-- Sidebar -->
 <nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
  ...
  <h4 class="w3-bar-item"><b>歡迎使用本系統</b></h4>
     ...
     <p><a href="http://localhost:8040/aaa/stu-register.jsp" id="first-time">註冊帳號</a>&emsp;&emsp;<a href="http://localhost:8040/aaa/stu-forget.jsp" id="forget">忘記密碼</a></p>
     </div>
